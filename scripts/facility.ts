...
const main = async () => {
  const serviceProviderData: ServiceProviderData = {
    serviceProvider: utils.arrayify(
      '0x8991ad64938cc0ceecc328dd28107facab94f509d1bd54ff3cf4511164edf1c7'
    ),
    ...
    items: [
      {
        item: utils.arrayify(
          '0x01e5404aa35dfe2b33fe4a714bfd301e0b5723dbbaf48454ee44b741b484900b'
        ),
        payload: Item.toBinary({
          ...
          payload: Space.toBinary({
            ...
            maxNumberOfChildOccupantsOneof: {
              oneofKind: 'maxNumberOfChildOccupantsException',
              maxNumberOfChildOccupantsException: Exception.UNSPECIFIED_REASON
            },
            ...
            views: {
              viewOfValleyOneof: {
                oneofKind: 'viewOfValley',
                viewOfValley: true
              },
              viewOfBeachOneof: {
                oneofKind: 'viewOfBeach',
                viewOfBeach: false
              },
              viewOfCityOneof: { oneofKind: 'viewOfCity', viewOfCity: false },
              viewOfGardenOneof: {
                oneofKind: 'viewOfGarden',
                viewOfGarden: false
              },
      ...
      {
        item: utils.arrayify(
          '0xc18597c11ae775cf21053832450e342b95b744db9abc45e17ced354a9f6517ff'
        ),
        payload: Item.toBinary({
